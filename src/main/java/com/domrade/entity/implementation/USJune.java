...
@NamedQueries({ @NamedQuery(name = "USJune.findAllEntries", query = "SELECT a FROM USJune a"),
		@NamedQuery(name = "USJune.findByProvenceState", query = "SELECT a FROM USJune a WHERE a.provenceState =:provenceState"),
		@NamedQuery(name = "USJune.findByCountryRegionProvinceState", query = "SELECT a FROM USJune a WHERE a.countryRegion =:countryRegion AND a.provenceState =:provenceState"),
		@NamedQuery(name = "USJune.findByCountryRegion", query = "SELECT a FROM USJune a WHERE a.countryRegion =:countryRegion") })
@Entity
@Table(name = "us_june")
public class USJune implements Serializable {

	public USJune() {
		// TODO Auto-generated constructor stub
	}

	public USJune(String provenceState, String countryRegion, String latitude, String longitude, String admin2, int _1,
	...
	public String toString() {
		return "USJune{" + "provenceState=" + provenceState + ", countryRegion=" + countryRegion + ", jun01=" + jun01
