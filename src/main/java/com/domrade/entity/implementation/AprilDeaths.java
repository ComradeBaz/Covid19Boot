...
@NamedQueries({
    @NamedQuery(name = "AprilDeaths.findAllEntries", query = "SELECT a FROM AprilDeaths a")
    ,
    @NamedQuery(name = "AprilDeaths.findByCountryRegionProvinceState", query = "SELECT a FROM AprilDeaths a WHERE a.countryRegion =:countryRegion AND a.provenceState =:provenceState")
    ,
    @NamedQuery(name = "AprilDeaths.findByCountryRegion", query = "SELECT a FROM AprilDeaths a WHERE a.countryRegion =:countryRegion")})
@Entity
@Table(name = "april_deaths")
public class AprilDeaths implements Serializable {

    public AprilDeaths() {
        // TODO Auto-generated constructor stub
    }

    public AprilDeaths(String provenceState, String countryRegion, String latitude, String longitude, int _1, int _2, int _3, int _4, int _5, 
    ...
    public boolean equals(Object obj) {
        ...
        final AprilDeaths other = (AprilDeaths) obj;
    ...
    public String toString() {
        return "AprilDeaths{" + "provenceState=" + provenceState + ", countryRegion=" + countryRegion + ", Apr01=" 
                + apr01 + ", apr02=" + apr02 + ", apr03=" + apr03 + ", apr04=" + apr04 + ", apr05=" + apr05 
                + ", apr06=" + apr06 + ", apr07=" + apr07 + ", apr08=" + apr08 + ", apr09=" + apr09 + ", apr10=" 
                + apr10 + ", apr11=" + apr11 + ", apr12=" + apr12 + ", apr13=" + apr13 + ", apr14=" + apr14 + ", apr15=" 
                + apr15 + ", apr16=" + apr16 + ", apr17=" + apr17 + ", apr18=" + apr18 + ", apr19=" + apr19 + ", apr20=" 
                + apr20 + ", apr21=" + apr21 + ", apr22=" + apr22 + ", apr23=" + apr23 + ", apr24=" + apr24 + ", apr25=" 
                + apr25 + ", apr26=" + apr26 + ", apr27=" + apr27 + ", apr28=" + apr28 + ", apr29=" + apr29 + '}';
    }
