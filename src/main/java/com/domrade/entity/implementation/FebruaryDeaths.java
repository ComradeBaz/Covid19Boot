 ...
 */
@NamedQueries({
    @NamedQuery(name = "FebruaryDeaths.findAllEntries", query = "SELECT f FROM FebruaryDeaths f")
    ,
    @NamedQuery(name = "FebruaryDeaths.findAllCountryRegion", query = "SELECT DISTINCT f.countryRegion FROM FebruaryDeaths f")
    ,
    @NamedQuery(name = "FebruaryDeaths.findByCountryRegionProvinceState", query = "SELECT f FROM FebruaryDeaths f WHERE f.countryRegion =:countryRegion AND f.provenceState =:provenceState")
    ,
    @NamedQuery(name = "FebruaryDeaths.findProvincetateByCountry", query = "SELECT f.provenceState FROM FebruaryDeaths f WHERE f.countryRegion =:countryRegion")
    ,
    @NamedQuery(name = "FebruaryDeaths.findByCountryRegion", query = "SELECT f FROM FebruaryDeaths f WHERE f.countryRegion =:countryRegion")
,
    @NamedQuery(name = "FebruaryDeaths.findProvinceStateByCountryRegion", query = "SELECT f.provenceState FROM FebruaryDeaths f WHERE f.countryRegion =:countryRegion")})
@Entity
@Table(name = "february_deaths")
public class FebruaryDeaths implements Serializable {
    
    public FebruaryDeaths() {
        // TODO Auto-generated constructor stub
    }

    public FebruaryDeaths(long id, String provenceState, String countryRegion, String latitude, String longitude, int _1, int _2, int _3, int _4, int _5, 
    ...
    public boolean equals(Object obj) {
        ...
        final FebruaryDeaths other = (FebruaryDeaths) obj;
    ...
    public String toString() {
        return "FebruaryDeaths{" + "provenceState=" + provenceState + ", countryRegion=" + countryRegion + ", Feb01=" 
