...
@Entity
@Table(name = "us_january_deaths")
public class USJanuaryDeaths implements Serializable {

	public USJanuaryDeaths() {
	...
	public boolean equals(Object obj) {
		...
		final USJanuaryDeaths other = (USJanuaryDeaths) obj;
	...
	public String toString() {
		return "USJanuaryDeaths{" + "provenceState=" + provenceState + ", countryRegion=" + countryRegion + ", jan22="
				+ jan22 + ", jan23=" + jan23 + ", jan24=" + jan24 + ", jan25=" + jan25 + ", jan26=" + jan26 + ", jan27="
				+ jan27 + ", jan28=" + jan28 + ", jan29=" + jan29 + '}';
	}
