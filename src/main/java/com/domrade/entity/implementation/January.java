 ...
 */
@NamedQueries({
    @NamedQuery(name = "January.findAllEntries", query = "SELECT j FROM January j")
    ,
    @NamedQuery(name = "January.findByCountryRegionProvinceState", query = "SELECT j FROM January j WHERE j.countryRegion =:countryRegion AND j.provenceState =:provenceState")
    ,
    @NamedQuery(name = "January.findByCountryRegion", query = "SELECT j FROM January j WHERE j.countryRegion =:countryRegion")})
@Entity
@Table(name = "january")
public class January implements Serializable {
    
    public January() {
        // TODO Auto-generated constructor stub
    }

    public January(long id, String provenceState, String countryRegion, String latitude, String longitude, int _22, int _23, int _24, 
    ...
    public boolean equals(Object obj) {
        ...
        final January other = (January) obj;
    ...
    public String toString() {
        return "January{" + "provenceState=" + provenceState + ", countryRegion=" + countryRegion 
