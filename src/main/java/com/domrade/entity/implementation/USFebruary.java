...
@NamedQueries({ @NamedQuery(name = "USFebruary.findAllEntries", query = "SELECT f FROM USFebruary f"),
		...
		@NamedQuery(name = "USFebruary.findProvincetateByCountry", query = "SELECT f.provenceState FROM USFebruary f WHERE f.countryRegion =:countryRegion ORDER BY f.provenceState ASC"),
		@NamedQuery(name = "USFebruary.findByCountryRegion", query = "SELECT f FROM USFebruary f WHERE f.countryRegion =:countryRegion"),
		@NamedQuery(name = "USFebruary.findProvinceStateByCountryRegion", query = "SELECT f.provenceState FROM USFebruary f WHERE f.countryRegion =:countryRegion") })
@Entity
@Table(name = "us_february")
public class USFebruary implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		final USFebruary other = (USFebruary) obj;
	...
	public String toString() {
		return "USFebruary{" + "provenceState=" + provenceState + ", countryRegion=" + countryRegion + ", Feb01="
				+ feb01 + ", feb02=" + feb02 + ", feb03=" + feb03 + ", feb04=" + feb04 + ", feb05=" + feb05 + ", feb06="
				+ feb06 + ", feb07=" + feb07 + ", feb08=" + feb08 + ", feb09=" + feb09 + ", feb10=" + feb10 + ", feb11="
				+ feb11 + ", feb12=" + feb12 + ", feb13=" + feb13 + ", feb14=" + feb14 + ", feb15=" + feb15 + ", feb16="
				+ feb16 + ", feb17=" + feb17 + ", feb18=" + feb18 + ", feb19=" + feb19 + ", feb20=" + feb20 + ", feb21="
				+ feb21 + ", feb22=" + feb22 + ", feb23=" + feb23 + ", feb24=" + feb24 + ", feb25=" + feb25 + ", feb26="
				+ feb26 + ", feb27=" + feb27 + ", feb28=" + feb28 + ", feb29=" + feb29 + '}';
	}
