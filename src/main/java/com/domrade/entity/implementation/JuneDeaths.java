...
@NamedQueries({ @NamedQuery(name = "JuneDeaths.findAllEntries", query = "SELECT a FROM JuneDeaths a"),
		@NamedQuery(name = "JuneDeaths.findByCountryRegionProvinceState", query = "SELECT a FROM JuneDeaths a WHERE a.countryRegion =:countryRegion AND a.provenceState =:provenceState"),
		@NamedQuery(name = "JuneDeaths.findByCountryRegion", query = "SELECT a FROM JuneDeaths a WHERE a.countryRegion =:countryRegion") })
@Entity
@Table(name = "june_deaths")
public class JuneDeaths implements Serializable {

	public JuneDeaths() {
		// TODO Auto-generated constructor stub
	}

	public JuneDeaths(String provenceState, String countryRegion, String latitude, String longitude, int _1, int _2,
	...
	public boolean equals(Object obj) {
		...
		final JuneDeaths other = (JuneDeaths) obj;
	...
	public String toString() {
		return "JuneDeaths{" + "provenceState=" + provenceState + ", countryRegion=" + countryRegion + ", Jun01="
