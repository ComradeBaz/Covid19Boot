 ...
 */
@NamedQueries({
    @NamedQuery(name = "JanuaryDeaths.findAllEntries", query = "SELECT j FROM JanuaryDeaths j")
    ,
    @NamedQuery(name = "JanuaryDeaths.findByCountryRegionProvinceState", query = "SELECT j FROM JanuaryDeaths j WHERE j.countryRegion =:countryRegion AND j.provenceState =:provenceState")
    ,
    @NamedQuery(name = "JanuaryDeaths.findByCountryRegion", query = "SELECT j FROM JanuaryDeaths j WHERE j.countryRegion =:countryRegion")})
@Entity
@Table(name = "january_deaths")
public class JanuaryDeaths implements Serializable {
    
    public JanuaryDeaths() {
        // TODO Auto-generated constructor stub
    }

    public JanuaryDeaths(long id, String provenceState, String countryRegion, String latitude, String longitude, int _22, int _23, int _24, 
            int _25, int _26, int _27, int _28, int _29, int _30, int _31) {
    ...
    public boolean equals(Object obj) {
        ...
        final JanuaryDeaths other = (JanuaryDeaths) obj;
    ...
    public String toString() {
        return "JanuaryDeaths{" + "provenceState=" + provenceState + ", countryRegion=" + countryRegion 
                + ", jan22=" + jan22 + ", jan23=" + jan23 + ", jan24=" + jan24 + ", jan25=" 
                + jan25 + ", jan26=" + jan26 + ", jan27=" + jan27 + ", jan28=" + jan28 + ", jan29=" + jan29 + '}';
    }
