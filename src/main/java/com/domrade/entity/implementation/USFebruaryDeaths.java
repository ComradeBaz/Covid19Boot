...
@NamedQueries({ @NamedQuery(name = "USFebruaryDeaths.findAllEntries", query = "SELECT f FROM USFebruaryDeaths f"),
		...
		@NamedQuery(name = "USFebruaryDeaths.findByCountryRegion", query = "SELECT f FROM USFebruaryDeaths f WHERE f.countryRegion =:countryRegion"),
		@NamedQuery(name = "USFebruaryDeaths.findProvinceStateByCountryRegion", query = "SELECT f.provenceState FROM USFebruaryDeaths f WHERE f.countryRegion =:countryRegion") })
@Entity
@Table(name = "us_february_deaths")
public class USFebruaryDeaths implements Serializable {

	public USFebruaryDeaths() {
	...
	public boolean equals(Object obj) {
		...
		final USFebruaryDeaths other = (USFebruaryDeaths) obj;
	...
	public String toString() {
		return "USFebruaryDeaths{" + "provenceState=" + provenceState + ", countryRegion=" + countryRegion + ", Feb01="
