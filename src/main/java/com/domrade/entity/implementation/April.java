...
@NamedQueries({
    @NamedQuery(name = "April.findAllEntries", query = "SELECT a FROM April a")
    ,
    @NamedQuery(name = "April.findByCountryRegionProvinceState", query = "SELECT a FROM April a WHERE a.countryRegion =:countryRegion AND a.provenceState =:provenceState")
    ,
    @NamedQuery(name = "April.findByCountryRegion", query = "SELECT a FROM April a WHERE a.countryRegion =:countryRegion")})
@Entity
@Table(name = "april")
public class April implements Serializable {

    public April() {
        // TODO Auto-generated constructor stub
    }

    public April(String provenceState, String countryRegion, String latitude, String longitude, int _1, int _2, int _3, int _4, int _5, 
    ...
    public String toString() {
        return "April{" + "provenceState=" + provenceState + ", countryRegion=" + countryRegion + ", Apr01=" 
