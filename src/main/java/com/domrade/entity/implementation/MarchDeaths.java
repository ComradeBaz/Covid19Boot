...
@NamedQueries({
    @NamedQuery(name = "MarchDeaths.findAllEntries", query = "SELECT m FROM MarchDeaths m")
    ,
    @NamedQuery(name = "MarchDeaths.findByCountryRegionProvinceState", query = "SELECT m FROM MarchDeaths m WHERE m.countryRegion =:countryRegion AND m.provenceState =:provenceState")
    ,
    @NamedQuery(name = "MarchDeaths.findByCountryRegion", query = "SELECT m FROM MarchDeaths m WHERE m.countryRegion =:countryRegion")})
@Entity
@Table(name = "march_deaths")
public class MarchDeaths implements Serializable {

    public MarchDeaths() {
        // TODO Auto-generated constructor stub
    }

    public MarchDeaths(long id, String provenceState, String countryRegion, String latitude, String longitude, int _1, int _2, int _3, int _4, int _5, 
    ...
    public boolean equals(Object obj) {
        ...
        final MarchDeaths other = (MarchDeaths) obj;
    ...
    public String toString() {
        return "MarchDeaths{" + "provenceState=" + provenceState + ", countryRegion=" + countryRegion + ", mar01=" 
